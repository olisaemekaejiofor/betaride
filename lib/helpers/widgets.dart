...
Column formField({TextEditingController controller, String label, String hintText}) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
  ...
  return Drawer(
    child: Container(
      ...
      child: Column(children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    FutureBuilder(
                      future: userName,
                      builder: (context, AsyncSnapshot<ProfileData> snapshot) => Text(
                        snapshot.data.firstname + " " + snapshot.data.lastname ?? "null null",
                        style: GoogleFonts.notoSans(
                          color: Colors.white,
                          fontWeight: FontWeight.w600,
                          fontSize: 19.0,
        ...
        SizedBox(height: 15),
        CustomTile(name: "Home", iconName: "home 1", widget: Home(true, false)),
...
Widget expansion(BuildContext context) {
  return ExpansionTile(
    textColor: Colors.black,
    leading: CircleAvatar(radius: 25, backgroundImage: AssetImage("assets/bgdraw.png")),
    title: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Tobi Dayo",
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              ...
              child: Text(
                buttonLabel2,
                style: GoogleFonts.notoSans(color: Color(0xffFF9411), fontWeight: FontWeight.w600),
              ),
            ),
          ),
        ],
